...
public class BusinessServiceImpl {
	/* 使用工厂类生成DAO对象 */
	private AdminDAO aDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.AdminDAOImpl", AdminDAO.class);
	private UserDAO uDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.UserDAOImpl", UserDAO.class);
	private OrderDAO oDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.OrderDAOImpl", OrderDAO.class);
	private MovieDAO movieDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.MovieDAOImpl", MovieDAO.class);
	private ScheduleDAO sDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.ScheduleDAOImpl", ScheduleDAO.class);
	private VideohallDAO vDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.VideohallDAOImpl", VideohallDAO.class);
	private CinemaDAO cDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.CinemaDAOImpl", CinemaDAO.class);
	private ScheduleViewDAO svDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.ScheduleViewDAOImpl", ScheduleViewDAO.class);
	private SeatDAO seatDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.SeatDAOImpl", SeatDAO.class);
	private CommentDAO commentDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.CommentDAOImpl", CommentDAO.class);
	private CollectionDAO collectionDAO = DAOFactory.getInstance().createDAO(
			"com.cpp2.dao.impl.CollectionDAOImpl", CollectionDAO.class);
	...
	public Result getAllUserPageData(int currentPage, int everyPage) {
		...
		List<User> list = uDAO.getAllUserPageDate(page.getBeginIndex(),
				everyPage);
		result.setPage(page);
		result.setList(list);
		return result;
	...
	public Result getAllMoviePageData(int currentPage, int everyPage) {
		...
		Page page = PageUtil.createPage(everyPage, totalCount, currentPage);
		List<Movie> list = movieDAO.getMoviePageData(page.getBeginIndex(),
				everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	...
	public Result getOnNowMoviePageData(int currentPage, int everyPage) {
		...
		Page page = PageUtil.createPage(everyPage, totalCount, currentPage);
		List<Movie> list = movieDAO.getOnNowMoviePageData(page.getBeginIndex(),
				everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	...
	public Result getComingSoonMoviePageData(int currentPage, int everyPage) {
		...
		Page page = PageUtil.createPage(everyPage, totalCount, currentPage);
		List<Movie> list = movieDAO.getComingSoonMoviePageData(
				page.getBeginIndex(), everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	}
	 ...
	 * @return
	 */
	public Result getAllOrderPageData(int currentPage, int everyPage,
			String state) {
		Result result = new Result();
		int totalCount = oDAO.getTotalRecord();
		Page page = PageUtil.createPage(everyPage, totalCount, currentPage);
		List<Order> list = oDAO.getAllOrderPageDate(page.getBeginIndex(),
				everyPage, state);
		result.setPage(page);
		result.setList(list);
		return result;
	...
	public Result getAllSchedulePageData(int everyPage, int currentPage) {
		...
		List<Schedule> list = sDAO.getAllSchedulePageDate(page.getBeginIndex(),
				everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	 ...
	 * @return
	 */
	public List<Schedule> getScheduleByMovieIdAndCinemaId(int movie_id,
			int cinema_id) {
	 ...
	 * @return
	 */
	public List<ScheduleView> getScheduleViewByMovieIdAndCinemaId(int movie_id,
			int cinema_id) {
	...
	public Result getAllScheduleViewPageData(int everyPage, int currentPage) {
		...
		Page page = PageUtil.createPage(everyPage, totalRecord, currentPage);
		List<ScheduleView> list = svDAO.getAllScheduleViewPageData(
				page.getBeginIndex(), everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	 ...
	 * @return
	 */
	public Result getCommentPageData(int everyPage, int currentPage,
			int movie_id) {
		Result result = new Result();
		int totalRecord = commentDAO.getTotalRecord(movie_id);
		Page page = PageUtil.createPage(everyPage, totalRecord, currentPage);
		List<Comment> list = commentDAO.showComment(movie_id,
				page.getBeginIndex(), everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
	...
	public Result getAllCollection(int user_id, int everyPage, int currentPage) {
		...
		Page page = PageUtil.createPage(everyPage, totalRecord, currentPage);
		List<Collection> list = collectionDAO.showCollection(user_id,
				page.getBeginIndex(), everyPage);
		result.setList(list);
		result.setPage(page);
		return result;
